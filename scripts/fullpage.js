    ...
    function initialise(containerSelector, options) {
        ...
        */
        function addVerticalNavigation(){
            ...
            myDiv.className = "nav-dragger";
            myDiv.id = "draggerID"
            navigation.appendChild(myDiv);
            // var tracker = document.createElement('div');
            // tracker.className = "section-tracker";
            // myDiv.appendChild(tracker);
            // var navBox = document.getElementById('fp-nav');
            // var navLine = document.createElement('div');
            // navLine.className = "nav-line"
            // navBox.appendChild(navLine);
            ...
            // added code
            addClass(nav, 'nav-container');
            addClass(nav, 'nav-container-hide');
            // end added code
